...
Page({
  ...
  nextTap: function (e) {
    ...
    const { type, product_id: id, id: tuan_id, fromUid, product: { fill_info, fill_form, title, valid_btime, valid_etime, address, session, sale_type, can_refund = false, include_bx, shop_id, product_cover_url }, hx_rule, has_postage } = this.data
