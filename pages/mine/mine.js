...
Page({
  ...
  data: {
    ...
    order_type: [
      ...
      { icon: 'http://i2.bvimg.com/685753/ba211fc91e6e6ee6.png', type: '3', title: '待评价'},
      { icon: 'http://i2.bvimg.com/685753/f547ae1b15e55e1a.png', type: '4', title: '退款订单'}
    ],
    is_partner: true,
    profit: {
      all: 60,
    ...
    other_entrances: [
      ...
      { title: '联系客服', path: '', phone: '1234567890'},
      { title: '业务合作', path: '/pages/cooperation/cooperation'}
    ]
  },
